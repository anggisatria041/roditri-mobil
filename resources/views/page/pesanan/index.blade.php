                    ...
                    <div class="cart_inner">
                        @if ($jatuhTempo)
                            <div class="check_title">
                                <h2>
                                    Ada Cicilan Anda yang Jatuh Tempo!
                                    <a
                                        href="{{ url('roditri-mobil/detail_cicilan/' . Crypt::encryptString($jatuhTempo->pemesanan->id)) }}">
                                        Klik Disini
                                    </a>
                                </h2>
                            </div>
                                    ...
                                    @foreach ($pemesanan as $item)
                                        <tr>
                                            <td>
                                                <div class="media">
                                                    <div class="d-flex">
                                                        <img src="{{ Storage::url($item->produk->foto1) }}" alt=""
        ...
        <section class="features-area section_gap">
            <div class="container">
                <div class="row features-inner">
                    <div class="col-lg-12 col-md-6 col-sm-6">
                        <div class="single-features">
                            <h6>Silahkan <a href="{{ route('login') }}" style="text-decoration: none; color: red;"> login
                                </a>terlebih dahulu untuk melihat riwayat pesanan anda</h6>
                            <p>Terima Kasih!</p>
                        </div>
                    </div>
                </div>
