                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-6">
                            ...
                            @elseif($data->status_pemesanan == 'Ditarik')
            ...
            <div class="card mb-5 mb-xl-12" id="kt_profile_details_view">
                ...
                @endif
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            @if (in_array($data->status_pemesanan, ['Selesai', 'Ditarik']))
                                -
                            @else
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-light dropdown-toggle" type="button"
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item btn-verifikasi" data-id="{{ $data->id }}"
                                                data-status="Ditarik" data-verifikasi="status_pemesanan"
                                                data-model="Pemesanan">Ditarik</a>
                                        </li>
                                    </ul>
                                </div>
                            @endif
                            ...
                            <tbody>
                                @foreach ($cicilan as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if (\Carbon\Carbon::parse($item->tanggal_jatuh_tempo)->lte(\Carbon\Carbon::today()))
                                        ...
                                        <td>
                                            ...
                                            @if ($item->status == 'pending' && $selisih < -3)
                                                <span class="text-danger fw-bold">Terlambat bayar, status:
                                                    <u>Ditarik</u></span>
                                            @else
